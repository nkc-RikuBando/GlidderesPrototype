...
public class SkillCreator : EditorWindow
{
    ...
    {
        // スキル名称の入力
        name = EditorGUILayout.TextField("スキル名称", name, GUILayout.Width(nameWindowSize.x), GUILayout.Height(nameWindowSize.y));
        ...
        // デバッグ用
        if (GUILayout.Button("Count(デバッグ用)"))
        {
            int cnt = 0;
